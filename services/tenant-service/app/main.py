...
app.add_middleware(AuditMiddleware, valkey_url=settings.valkey_url, service_name="tenant-service")
# TenantContextMiddleware validates the platform admin JWT (gxp-platform realm)
# tenant_slug will be None for all valid platform admin requests

...
app = FastAPI(title="GXP Notification Service", version="0.1.0", lifespan=lifespan)
...
app.add_middleware(AuditMiddleware, valkey_url=settings.valkey_url, service_name="notification-service")

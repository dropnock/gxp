...
app = FastAPI(
    title="GXP Document Service",
    version="0.1.0",
    lifespan=lifespan,
    docs_url="/api/v1/documents/docs",
    openapi_url="/api/v1/documents/openapi.json",
    redoc_url="/api/v1/documents/redoc",
)
...
app.add_middleware(AuditMiddleware, valkey_url=settings.valkey_url, service_name="document-service")
